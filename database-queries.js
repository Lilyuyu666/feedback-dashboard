// Database Queries - All D1 database operations

// Database query functions - connects to your feedback_150 table
export async function getFeedbackFromDB(env) {
  try {
...
export async function getMetricsFromDB(env) {
  try {
...
export async function getAnalysisFromDB(env) {
  try {
    const tableName = 'feedback_150';
